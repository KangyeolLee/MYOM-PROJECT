				...
				<ul id="slide-out" className="sidenav sidenav-fixed grey lighten-4">
						...
						<li>
							...
							<div className="collapsible-body">
								<ul className="collection">
									<ChatLists chat_type = 'dealChats' profile={ profile } chats = {chatInDeal} newChatBtnFn = {this.props.newChatBtnFn} selectChatFn = {this.props.selectChatFn} selectedChatIndex = {this.props.selectedChatIndex}></ChatLists>
								</ul>
							</div>
						</li>
					</ul>
					<ul className="collapsible">
						<li className="active">
							...
							<div className="collapsible-body">
								<ul className="collection">
								<ChatLists chat_type="allChats" profile={ profile } chats = {chats} newChatBtnFn = {this.props.newChatBtnFn} selectChatFn = {this.props.selectChatFn} selectedChatIndex = {this.props.selectedChatIndex}></ChatLists>		
								</ul>
							</div>
						</li>
					</ul>
