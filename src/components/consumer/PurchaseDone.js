      ...
      <div className="card">
        <div className="card-content">
          ...
          <div className="center purchasedone-btns row">
            <Link to='/' className="center col s4 offset-s1 btn waves-effect waves-light indigo purchasedone-btn"><i className="material-icons homeIcon">home</i><span>홈으로 돌아가기</span></Link>
