      ...
      <div className="card">
        <div className="card-content">
          ...
          <div className="center purchasedone-btns row">
            <Link to={'/requestForm/' + service_id } className="center col s4 offset-s4 btn waves-effect waves-light indigo purchasedone-btn"><i className="material-icons homeIcon">descriptions</i><span>상세요청서 작성</span></Link>
